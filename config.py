...
# === STREAMLIT НАСТРОЙКИ ===
PAGE_TITLE = "Pharma Data Viz"
PAGE_ICON = "📊"
LAYOUT = "centered"  # "centered" за мобилни, "wide" за десктоп
...
METRICS = ["Units (опак.)", "Market Share (%)", "% Ръст"]

# Височина на графики (увеличена за мобилни)
CHART_HEIGHT = 600  # По-високи графики за четливост на малък екран
BRICK_CHART_HEIGHT = 550
TIMELINE_CHART_HEIGHT = 600  # Специално за timeline графиките
