...
def render_evolution_index_tab(
    ...
    # По подразбиране от филтрите: Всички -> national; избран регион/брик -> sidebar или brick
    default_idx = 0
    sel_district = filters.get("district", "Всички")
    if sel_region and sel_region != "Всички":
        if sel_district and sel_district != "Всички":
            default_idx = 1
        else:
